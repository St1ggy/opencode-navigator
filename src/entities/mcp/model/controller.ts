...
import { type DesiredMcpStates, type McpPresets, preferencesScope } from '../../../shared/config'
...
export type McpPreferencesAccess = {
  ...
  desiredMcpState(scope: string, name: string): DesiredMcpStates[string] | undefined
  setDesiredMcpState(scope: string, name: string, state: DesiredMcpStates[string]): void
  setDesiredMcpStates?(scope: string, states: DesiredMcpStates): void
}
