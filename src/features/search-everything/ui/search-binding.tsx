...
import { LEGACY_PLUGIN_ID, SEARCH_COMMAND } from '../../../shared/config'
import { searchContext } from '../model/search'

import { type SearchServices, openSearchEverything } from './search-everything-dialog'

import type { Renderable } from '@opentui/core'

type SearchInteraction = {
  ownsFocus: () => boolean
  savedReturnTarget: () => Renderable | undefined
}

export function SearchBinding(props: SearchServices & { interaction: SearchInteraction }) {
