...
export function sectionIcon(section: SectionIconName, style: IconStyle = 'nerd') {
...
export function quickActionIcon(command: string, style: IconStyle = 'nerd') {
  return uiIcon(ACTION_ICONS[QUICK_ACTION_IDS.indexOf(command as QuickActionId)] ?? 'actions', style)
}
